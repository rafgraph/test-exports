...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exportTest = __webpack_require__(168);
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function addDates() {
	      this.setState({
	        importTest: this.state.importTest.concat('Date from function called on export: ' + _exportTest2.default, 'Date from imported function called now: ' + (0, _exportTest.dateNow)(), '')
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.state.importTest.map(function (v, i) {
	            return _react2.default.createElement(
	              'li',
	              { key: i },
	              v
