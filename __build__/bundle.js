...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Test = __webpack_require__(/*! ./Test */ 168);
	
	var _Test2 = _interopRequireDefault(_Test);
	
	var _exportTest = __webpack_require__(/*! ./exportTest.js */ 170);
	
	var _exportTest2 = _interopRequireDefault(_exportTest);
	
	var _exportObjectTest = __webpack_require__(/*! ./exportObjectTest */ 169);
	
	var _exportObjectTest2 = _interopRequireDefault(_exportObjectTest);
	...
	var a = _exportObjectTest2.default['state']['a'];
	...
	var App = function (_React$Component) {
	  ...
	  function App(props) {
	    ...
	    _this.state = { importDateTest: [], importObjectState: [_exportObjectTest2.default['state']['a']] };
	    _this.addDates = _this.addDates.bind(_this);
	    _this.updateImportObject = _this.updateImportObject.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(App, [{
	    ...
	    value: function addDates() {
	      this.setState({
	        importDateTest: this.state.importDateTest.concat('Date from function called on export: ' + _exportTest2.default, 'Date from imported function called now: ' + (0, _exportTest.dateNow)(), '')
	      });
	    }
	  }, {
	    key: 'updateImportObject',
	    value: function updateImportObject() {
	      this.setState({
	        importObjectState: this.state.importObjectState.concat(_exportObjectTest2.default['state']['a'])
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.state.importDateTest.map(function (v, i) {
	            return _react2.default.createElement(
	              'li',
	              { key: i },
	              v
	        ...
	        _react2.default.createElement(
	          'h4',
	          null,
	          'Check the state of exported object'
	        ),
	        _react2.default.createElement(
	          'button',
	          { onClick: this.updateImportObject },
	          'click to get current state of import object'
	        ),
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.state.importObjectState.map(function (v, i) {
	            return _react2.default.createElement(
	              'li',
	              { key: i },
	              v
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Test = function (_React$Component) {
	  ...
	  function Test(props) {
	    ...
	    _this.state = { importObjectState: [_exportObjectTest2.default['state']['a']] };
	    _this.updateImportObject = _this.updateImportObject.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Test, [{
	    key: 'updateImportObject',
	    value: function updateImportObject() {
	      _exportObjectTest2.default.update('a', Math.floor(Math.random() * 1000));
	      this.setState({
	        importObjectState: this.state.importObjectState.concat(_exportObjectTest2.default['state']['a'])
	      });
